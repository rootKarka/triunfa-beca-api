...
export const agregarOpcion = async (req,res,next) => {
  try {
    const data = await service.crearOpcion(
      req.params.codigo, req.body.nombre, req.body.orden, getUsuarioId(req)
    );
...
export const editarOpcion = async (req,res,next) => {
  try {
    const data = await service.actualizarOpcion(
      req.params.id, req.body.nombre, req.body.orden, getUsuarioId(req)
    );
...
export const actualizarEstado = async (req,res,next) => {
  try {
    const data = await service.cambiarEstadoOpcion(
      req.params.id, req.body.activo, getUsuarioId(req)
    );
...
export const eliminarOpcion = async (req,res,next) => {
  try {
